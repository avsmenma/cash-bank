      ...
      <div class="card-body">
        <div class="tab-content">
          ...
          <div class="active tab-pane" id="activity">
            <div class="row no-print">
              <div class="col-12 gap-4">
                ...
                <a href="{{ url('/bank-masuk/export_excel')}}" class="btn btn-outline-danger"><i class="nav-icon fas fa-file-excel"></i> Download Excel</a>
                <button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#filterCollapse"><i class="nav-icon fas fa-filter"></i> Filter</button>
              </div>
            </div>
            ...
            <div class="collapse mt-3" id="filterCollapse">
              <div class="d-flex gap-2">
                ...
                <a href="#" class="btn btn-danger"><i class="nav-icon fas fa-user-secret"></i> Reset Filter</a>
              </div>
            </div>
          ...
          <div class="tab-pane" id="timeline">
            <div class="row no-print mb-3">
              <div class="col-12">
                <div class="d-flex gap-2">
                  <a href="{{ url('/bank-masuk/view/pdf')}}" target="_blank" class="btn btn-outline-primary"><i class="fas fa-print"></i> Download PDF</a>
                  <a href="{{ url('/bank-masuk/export_excel')}}" class="btn btn-outline-danger"><i class="nav-icon fas fa-file-excel"></i> Download Excel</a>
                  <select class="select2" id="tahunCashflow" style="width: 150px;">
                    @for($t = date('Y') - 5; $t <= date('Y') + 5; $t++)
            ...
            {{-- CASHFLOW CONTENT - ID UNIK --}}
            <div id="cashflow-content" class="p-3 text-center">
              <span class="text-muted">Memuat data cashflow...</span>
            </div>
          </div>
