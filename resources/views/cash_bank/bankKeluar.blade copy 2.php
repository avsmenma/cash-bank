                ...
                <!-- title row -->
                    <div class="row no-print">
                        <div class="col-12 gap-4">
                            ...
                            <a href="javascript:void(0)" class="btn btn-success" data-toggle="modal" data-target="#ModalCreateKeluar"><i class="fas fa-plus"></i> Tambah Data</a>
                            <a href="{{ url('/bank-keluar/view/pdf')}}" target="_blank" class="btn btn-outline-primary"><i class="fas fa-print"></i> Download PDF</a>
                            <a href="{{ url('/bank-keluar/export_excel')}}" class="btn btn-outline-danger " ><i class=" nav-icon fas fa-file-excel"></i></i> Download Excel</a>
                        </div>
                    </div>
                    <hr>
