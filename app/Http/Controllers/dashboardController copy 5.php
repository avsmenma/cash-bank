...
class dashboardController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Filter bulan - HANYA tampilkan bulan yang ada transaksi
        $bulanListFiltered = [];
        if (!empty($bulanAktif)) {
        ...
        // Jika tidak ada bulan dengan transaksi, tampilkan pesan atau return kosong
    ...
    public function data2(Request $request)
    {
        ...
        return view('cash_bank.dashbordKedua', compact('result', 'bulanListFiltered', 'tahun', 'bulanDari', 'bulanSampai'));
    }
