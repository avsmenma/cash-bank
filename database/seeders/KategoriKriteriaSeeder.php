...
class KategoriKriteriaSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $data = [
            ...
            ['id_kategori_kriteria' => 9, 'nama_kriteria' => 'Penjualan CPO (Minyak Sawit)', 'tipe' => 'Penerima'],
            ['id_kategori_kriteria' => 10, 'nama_kriteria' => 'Penjualan Kernel (Inti Sawit)', 'tipe' => 'Penerima'],
            ['id_kategori_kriteria' => 11, 'nama_kriteria' => 'Hapor', 'tipe' => 'Penerima'],
            ['id_kategori_kriteria' => 12, 'nama_kriteria' => 'Penjualan Cangkang (CK)', 'tipe' => 'Penerima'],
            ['id_kategori_kriteria' => 13, 'nama_kriteria' => 'Penjualan TBS', 'tipe' => 'Penerima'],
            ['id_kategori_kriteria' => 14, 'nama_kriteria' => 'Penjualan Karet (SIR 20/LUMP)', 'tipe' => 'Penerima'],
