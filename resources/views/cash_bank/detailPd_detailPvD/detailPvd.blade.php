                                        ...
                                        <div class="info-box bg-info">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">Rp
                                                    {{ number_format($totalPermintaanBulan, 0, ',', '.') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="info-box bg-success">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">Rp
                                                    {{ number_format($totalDroppingBulan, 0, ',', '.') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="info-box bg-danger">
                                            ...
                                            <div class="info-box-content">
                                                ...
                                                <span class="info-box-number">Rp
                                                    {{ number_format($totalPembayaranBulan, 0, ',', '.') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <ul class="nav nav-tabs" id="minggu{{ $minggu }}Tab" role="tablist">
                                <li class="nav-item">
                                    <a class="nav-link active" id="permintaan-tab-{{ $minggu }}" data-toggle="tab"
                                        href="#permintaan-{{ $minggu }}" role="tab">
                                        <i class="fas fa-file-invoice text-primary"></i> Permintaan
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="dropping-tab-{{ $minggu }}" data-toggle="tab"
                                        href="#dropping-{{ $minggu }}" role="tab">
                                        <i class="fas fa-hand-holding-usd text-success"></i> Dropping
                                    </a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" id="pembayaran-tab-{{ $minggu }}" data-toggle="tab"
                                        href="#pembayaran-{{ $minggu }}" role="tab">
                                                    ...
                                                    @foreach($weekData['permintaan']['data'] as $index => $item)
                                                        <tr>
                                                            ...
                                                            <td class="text-right">Rp
                                                                {{ number_format($item->{'M' . $minggu} ?? 0, 0, ',', '.') }}</td>
                                                            <td class="text-right">Rp
                                                                {{ number_format(($item->M1 + $item->M2 + $item->M3 + $item->M4), 0, ',', '.') }}
                                                            </td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                                <tfoot class="bg-light">
                                                    <tr>
                                                        ...
                                                        <th class="text-right">Rp
                                                            {{ number_format($weekData['permintaan']['total'], 0, ',', '.') }}</th>
                                                        <th></th>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                            ...
                                            <table class="table table-bordered table-sm table-hover">
                                                ...
                                                <tfoot class="bg-light">
                                                    <tr>
                                                        <th colspan="4" class="text-right">Total:</th>
                                                        <th class="text-right">Rp
                                                            {{ number_format($weekData['dropping']['total'], 0, ',', '.') }}</th>
                                                        <th></th>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                                ...
                                                <tbody>
                                                    @foreach($weekData['pembayaran']['data'] as $index => $item)
                                                        <tr>
                                                            ...
                                                            <td class="text-right">Rp
                                                                {{ number_format($item->nilai_rupiah ?? 0, 0, ',', '.') }}</td>
                                                        </tr>
                                                    @endforeach
                                                </tbody>
                                                <tfoot class="bg-light">
                                                    <tr>
                                                        ...
                                                        <th class="text-right">Rp
                                                            {{ number_format($weekData['pembayaran']['total'], 0, ',', '.') }}</th>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
