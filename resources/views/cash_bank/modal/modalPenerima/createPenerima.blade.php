                            ...
                            <div class="col-md-12 d-flex">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <select name="id_kategori_kriteria" id="create_kategori"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="create_kontrak" name="kontrak" class="form-control"
                            ...
                            <div class="col-md-12 d-flex">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="create_pembeli" name="pembeli" class="form-control"
                                            placeholder="Pembeli">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label>Tanggal</label>
                                        <div class="input-group date" id="create_reservationdate"
                                            data-target-input="nearest">
                                            <input type="text" name="tanggal" class="form-control datetimepicker-input"
                                                data-target="#create_reservationdate">
                                            <div class="input-group-append" data-target="#create_reservationdate"
                            ...
                            <div class="col-md-12 d-flex">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="create_no_reg" name="no_reg" class="form-control"
