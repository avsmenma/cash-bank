                ...
                <div class="col-12">
                  <div class="d-flex justify-content-between">
                    ...
                    <div class="d-flex gap-2 cb-fullscreen-support">
                      <button type="button" id="btn-export-pdf-dropping" class="btn btn-outline-primary">
                        <i class="fas fa-print"></i> Download PDF
                      </button>
                      <button type="button" id="btn-export-excel-dropping" class="btn btn-outline-danger">
  ...
  @push('scripts')
    <script>
      $(document).ready(function () {
        ...
        // Export PDF/Excel dropping sesuai filter terpilih
        function exportDropping(routeUrl, newTab) {
          let sub = $('#sub_kriteria').val();
          let tahun = $('#tahun').val();
          let bulan = $('#bulan').val();
        ...
        $('#btn-export-pdf-dropping').on('click', function () {
          exportDropping('{{ route("dropping.export_pdf") }}', true);
        });

        $('#btn-export-excel-dropping').on('click', function () {
          exportDropping('{{ route("dropping.export_excel") }}', false);
        });
