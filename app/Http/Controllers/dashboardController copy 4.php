...
class dashboardController extends Controller
{
    ...
    public function pvd($tahun, $bulanDari, $bulanSampai)
    {
        $bulanList = [
            1=>'Januari', 2=>'Februari', 3=>'Maret', 4=>'April',
            5=>'Mei', 6=>'Juni', 7=>'Juli', 8=>'Agustus',
        ...
        // ========== PERMINTAAN ==========
        $dropping = Permintaan::with(['kategori', 'subKriteria', 'itemSubKriteria'])
            ->where('tahun', $tahun)
            ->whereBetween('bulan', [$bulanDari, $bulanSampai])
            ->get();
        // ========== DROPPING ==========
     ...
     public function data2(Request $request)
    {
        ...
        $data = $this->pvd($tahun,$bulanDari,$bulanSampai);
        
        return view('cash_bank.dashbordKedua', $data);
    }
