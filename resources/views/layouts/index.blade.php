        ...
        <div class="sidebar">
            ...
            <nav class="mt-5">
                <ul class="nav nav-pills nav-sidebar flex-column"
                    ...
                    <li class="nav-item">
                        <a href="#" class="nav-link {{ request()->routeIs('dashboard.*','dashboard-pembayaran.*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('dashboard.pembayaran.index') }}" class="nav-link {{ request()->routeIs('dashboard.pembayaran.index')? 'active' : ''}}">
                                    <p>Dashboard</p>
                                </a>
                            </li>
                        </ul>
                    ...
                    <li class="nav-item">
                       <a href="{{ route('dropping.index') }}" class="nav-link {{ request()->routeIs('dropping.*')? 'active' : ''}}">
                           <i class="nav-icon fas fa-th"></i>
                            <p>Dropping</p>
                        </a>
                    </li>
                    ...
                    <!-- DAFTAR BANK -->
                    <li class="nav-item">
                        <a href="#" class="nav-link {{ request()->routeIs('bank-masuk.*','bank-keluar.*') ? 'active' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('bank-keluar.index') }}" class="nav-link {{ request()->routeIs('bank-keluar.index') ? 'active' : '' }}">
                                    <p>Bank Keluar</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('bank-keluar.report') }}" class="nav-link {{ request()->routeIs('bank-keluar.report') ? 'active' : '' }}">
                                    <p>Report Keluar</p>
                                </a>
                            </li>
                        </ul>
